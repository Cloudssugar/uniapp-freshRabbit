...
import { getgoodsbidAPI } from '@/services/sort'
...
const getgoodslist = async () => {
  let res = await getgoodsbidAPI(query.id)
  console.log(res)
...
<template>
  ...
  <view class="goods">
    ...
    <view class="preview">
      <swiper @change="onChange" class="swiper" circular>
        <swiper-item v-for="item in goodslist?.mainPictures" :key="item.id">
  ...
  <view class="detail panel">
    ...
    <view class="content">
      <view class="properties">
        ...
        <!-- 图片详情 -->
        <image v-for="item in goodslist?.details.pictures" :key="item" mode="widthFix" :src="item"></image>
      </view>
    </view>
  </view>
  ...
  <view class="similar panel">
    ...
    <view class="content">
      <navigator v-for="item in goodslist?.similarProducts" :key="item.id" class="goods" hover-class="none" :url="`/pages/goods/goods?id=${item.id}`">
  ...
  <view class="toolbar" :style="{ paddingBottom: safeAreaInsets?.bottom + 'px' }">
    <view class="icons">
      ...
      <navigator class="icons-button" url="/pages/cart/cart" open-type="switchTab"> <text class="icon-cart"></text>购物车 </navigator>
    </view>
    <view class="buttons">
